...
[![Tests](https://img.shields.io/badge/Tests-31_passed-green)](./backend/tests/)
[![PWA](https://img.shields.io/badge/PWA-ready-5A0FC8)](./frontend/public/manifest.json)
...
| 环境 | 地址 | 说明 |
|------|------|------|
| 🏠 **前端应用** | [http://localhost:5173](http://localhost:5173) | 本地开发 |
| 🔧 **后端 API** | [http://localhost:8000](http://localhost:8000) | 本地开发 |
| 📚 **API 文档** | [http://localhost:8000/docs](http://localhost:8000/docs) | Swagger UI |
| 🚀 **生产前端** | `https://ai-calendar.vercel.app` (待部署) | Vercel |
| ☁️ **生产后端** | `https://ai-calendar-api.railway.app` (待部署) | Railway |
...
| 文档 | 说明 | 链接 |
|------|------|:--:|
| 📋 **PRD** | 产品需求文档 — 功能规划、用户故事、版本计划 | [PRD.md](./PRD.md) |
| 🔧 **Tech** | 技术文档 — 架构设计、数据库、API、技术限制 | [tech.md](./tech.md) |
| 🎨 **Design** | 设计文档 — 色彩系统、组件规范、交互模式 | [design.md](./design.md) |
| 📘 **README** | 使用指南 — 快速开始、部署、API、FAQ | 本文档 |
...
| 功能 | 说明 | 状态 |
|------|------|:----:|
| 自然语言解析 | 中文日期/时间智能识别 (本地引擎) | ✅ |
| 任务分解 | DeepSeek AI 驱动，大任务→3-5个子任务 | ✅ |
| 智能分配 | AI 按技能匹配+负载均衡分配任务 | ✅ |
| AI 对话 | DeepSeek 智能助手，效率建议+规划咨询 | ✅ |
| 多 Provider | Claude / GPT / DeepSeek 可插拔切换 | ✅ |
