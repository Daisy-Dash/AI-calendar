...
| 联网搜索 | DeepSeek Function Calling + DuckDuckGo，AI 实时搜索互联网获取竞品/市场/最新信息 |
...
| 联网搜索 | ddgs (DuckDuckGo) | AI Function Calling 工具，无需额外 API Key |
...
│   │   ├── web_search.py        # DuckDuckGo 联网搜索 + 工具定义
│   │   ├── ai_split.py          # 任务分解引擎
...
AI (5)
  ...
  POST   /api/ai/search-chat            AI 联网搜索对话（Function Calling + DuckDuckGo）
